...
urlpatterns = [
    ...
    path('project-select-home/', project_views.ProjectSelectHomeView.as_view(), name='project-select-home'),
    path('project-select-results/', project_views.ProjectSelectResultsView.as_view(), name='project-select-results'),
